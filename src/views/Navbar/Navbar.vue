<template>
	<header
		:class="[position && position !=='' ? position + ' w-screen ' : '','z-50 lg:px-16 px-6 bg-black flex flex-wrap items-center lg:py-4 py-2']"
	>
		<div class="flex-1 flex justify-between items-center">
			<svg
				class="inline-block mr-2 h-10 fill-white"
				viewBox="0 0 63 20"
		...
		<div class="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
			<nav>
				<ul
					class="flex-col align-middle lg:flex-row flex lg:items-center justify-between text-base text-white pt-4 lg:pt-0"
				>
					<router-link
...
.navbar {
	@apply sticky bg-black pt-4 pb-4;
	min-height: 4rem;
}
